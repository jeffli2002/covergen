  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: `All video generation requires authentication and sufficient credits. Sora 2 videos cost ${PRICING_CONFIG.generationCosts.sora2Video} credits each, Pro videos cost ${PRICING_CONFIG.generationCosts.sora2ProVideo} credits. Free users don't have video access (video generation requires a paid plan). Pro plan ($${PRICING_CONFIG.plans[1].price.monthly.toFixed(1)}/month): ${PRICING_CONFIG.plans[1].credits.monthly} credits/month (up to ${Math.floor(PRICING_CONFIG.plans[1].credits.monthly / PRICING_CONFIG.generationCosts.sora2Video)} Sora 2 videos). Pro+ plan ($${PRICING_CONFIG.plans[2].price.monthly.toFixed(1)}/month): ${PRICING_CONFIG.plans[2].credits.monthly} credits/month (up to ${Math.floor(PRICING_CONFIG.plans[2].credits.monthly / PRICING_CONFIG.generationCosts.sora2Video)} Sora 2 videos or ${Math.floor(PRICING_CONFIG.plans[2].credits.monthly / PRICING_CONFIG.generationCosts.sora2ProVideo)} Pro videos). There are no daily or monthly quotas - generation is limited only by your available credits.`
      },
      {
