  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        {/* Professional Webinar Graphics Section */}
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600">
                  Everything you need to promote your webinar across all platforms
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 text-center">
                  ...
                  <h3 className="font-bold text-lg mb-2">Registration Banners</h3>
                  <p className="text-gray-600 text-sm">
                    Perfect for all platforms - Zoom, Teams, GoToWebinar, and more
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 text-center">
                  ...
                  <h3 className="font-bold text-lg mb-2">Professional Business Designs</h3>
                  <p className="text-gray-600 text-sm">
                    Clean, corporate-ready graphics that build trust and credibility
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 text-center">
                  ...
                  <p className="text-gray-600 text-sm">
                    Optimized formats for LinkedIn, Facebook, Twitter, and Instagram
                  </p>
                </div>
              </div>
            </div>
