    ...
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 via-purple-50 to-pink-50">
      <BreadcrumbWrapper>
        <Breadcrumb items={[
          ...
          { name: 'Game Cover Art', current: true }
        ]} />
      </BreadcrumbWrapper>
      ...
      {/* CTA Section */}
      <section className="cta-section py-20 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600">
