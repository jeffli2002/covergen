            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={type} className="bg-gradient-to-r from-pink-50 to-purple-50 rounded-2xl p-6 text-center hover:shadow-lg transition-shadow">
