...
export async function generateMetadata({ params: { locale } }: { params: { locale: string } }): Promise<Metadata> {
  return generateToolMetadata({
    tool: 'spotify-playlist-cover',
    locale,
    title: 'Spotify Playlist Cover ',
    description: 'AI-powered spotify playlist cover generator with perfect dimensions and instant results.',
          ...
          <div className="relative container mx-auto px-4 py-16 sm:py-24">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 text-sm font-medium mb-6">
                ...
                Low KD: Spotify Canvas Maker (24)
              </div>
              ...
              <div className="flex flex-wrap gap-4 justify-center mb-12">
                <a href="#tool" className="bg-green-400 text-black px-8 py-4 rounded-full font-semibold hover:bg-green-300 transition-all transform hover:scale-105">
