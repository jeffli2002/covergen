...
SET
    ...
    -- Note: subscriptions_consolidated doesn't have stripe_payment_method_id, keeping BestAuth value
    trial_started_at = COALESCE(sc.trial_started_at, bs.trial_started_at),
    trial_ends_at = COALESCE(sc.trial_ended_at, bs.trial_ends_at),
