...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://covergen.ai/platforms/twitch',
  },
}
...
export default function TwitchGraphicsMaker() {
  const howToSchema = {
      ...
      <div className="min-h-screen bg-background">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                <Link href="/#generator">
                  <Button size="lg" className="bg-white text-purple-800 hover:bg-purple-100 px-8 py-6 text-lg">
                    <Sparkles className="w-5 h-5 mr-2" />
                    Create Twitch Graphics
                  </Button>
                </Link>
                <Link href="/#pricing">
                  <Button size="lg" variant="outline" className="text-white border-white hover:bg-purple-700 px-8 py-6 text-lg">
                    View Pricing
                  </Button>
                </Link>
              </div>
        ...
        <section className="py-20 bg-gradient-to-br from-purple-800 to-purple-600 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <Link href="/#generator">
              <Button size="lg" className="bg-white text-purple-800 hover:bg-purple-100 px-8 py-6 text-lg font-semibold">
