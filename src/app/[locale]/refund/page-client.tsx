...
import { CreditCard, Clock, CheckCircle2, XCircle, AlertCircle, Mail, Shield, HelpCircle, ArrowLeft } from 'lucide-react'
          ...
          <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <p className="text-gray-600 text-sm">
                  {hasTrials 
                    ? `Annual plans also include a ${config.trialDays}-day trial period. After the trial, all payments are final. Consider monthly plans if you are unsure about long-term commitment.`
                    : 'Annual payments are final. Consider monthly plans if you are unsure about long-term commitment.'
                  }
                </p>
              </div>
