    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'The optimal YouTube thumbnail size is 1280x720 pixels with a 16:9 aspect ratio. CoverGen AI automatically generates thumbnails in this exact size for perfect YouTube compatibility.'
        }
      },
      {
        '@type': 'Question',
        name: 'How can I make my YouTube thumbnails more clickable?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Use high contrast colors, clear readable text, expressive faces, and avoid cluttered designs. CoverGen AI\'s YouTube optimization ensures your thumbnails follow these best practices automatically.'
        }
      },
      {
        '@type': 'Question',
        name: 'Can I use AI-generated thumbnails commercially?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes! With CoverGen AI Pro and Pro+ plans, you get full commercial usage rights for all generated thumbnails, perfect for monetized YouTube channels.'
        }
      }
    ]
  }
      ...
      <div className="min-h-screen bg-background">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-gray-600">
                No credit card required • 3 free thumbnails daily
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-gradient-to-br from-red-600 to-red-700 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <Link href={`/${locale}#generator`}>
              <Button size="lg" className="bg-white text-red-600 hover:bg-gray-100 px-8 py-6 text-lg font-semibold">
