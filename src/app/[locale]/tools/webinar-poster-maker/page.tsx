    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 via-indigo-50 to-purple-50">
      <BreadcrumbWrapper>
        <Breadcrumb items={[
          ...
          { name: 'Webinar Poster Maker', current: true }
        ]} />
      </BreadcrumbWrapper>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <h3 className="font-semibold mb-2">Business Training</h3>
              <p className="text-sm text-gray-900">Professional development, skills</p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              <div className="text-4xl mb-3">📊</div>
              <h3 className="font-semibold mb-2">Product Demos</h3>
              <p className="text-sm text-gray-900">Software demos, launches</p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              <div className="text-4xl mb-3">🎓</div>
              <h3 className="font-semibold mb-2">Educational Sessions</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              <div className="text-4xl mb-3">🎯</div>
              <h3 className="font-semibold mb-2">Marketing Seminars</h3>
              <p className="text-sm text-gray-900">Strategy sessions, insights</p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              <div className="text-4xl mb-3">🌍</div>
              <h3 className="font-semibold mb-2">Global Conferences</h3>
