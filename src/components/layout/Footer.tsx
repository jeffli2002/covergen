        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li>
                <Link href={`/${locale}/tools/thumbnail-tester`} className="hover:text-blue-600 transition-colors">
                  Thumbnail Tester
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/tools/instagram-thumbnail-maker`} className="hover:text-blue-600 transition-colors">
                  Instagram Maker
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href={`/${locale}/tools/linkedin-banner-maker`} className="hover:text-blue-600 transition-colors">
                  LinkedIn Banner
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href={`/${locale}/tools/podcast-cover-maker`} className="hover:text-blue-600 transition-colors">
                  Podcast Cover
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href={`/${locale}/tools/discord-banner-maker`} className="hover:text-blue-600 transition-colors">
                  Discord Banner
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href={`/${locale}/tools/kindle-cover-creator`} className="hover:text-blue-600 transition-colors">
                  Kindle Cover
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/tools/wattpad-cover-maker`} className="hover:text-blue-600 transition-colors">
                  Wattpad Cover
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href={`/${locale}/tools/event-poster-designer`} className="hover:text-blue-600 transition-colors">
                  Event Poster
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/tools/webinar-poster-maker`} className="hover:text-blue-600 transition-colors">
                  Webinar Poster
                </Link>
              </li>
              <li className="pt-2 border-t border-gray-300">
                <Link href={`/${locale}/tools`} className="hover:text-blue-600 transition-colors font-semibold">
                  View All Tools →
                </Link>
              </li>
            </ul>
