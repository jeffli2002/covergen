      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-pink-400 via-purple-400 to-blue-400 py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-hero-title text-white mb-6 drop-shadow-lg">
              Anime Poster Maker
            </h1>
            
            <p className="text-lg md:text-xl font-light text-white/90 mb-8 leading-relaxed max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-2xl mx-auto">
              <div className="text-center">
                <div className="text-heading-2 text-white">100+</div>
                <div className="text-body-sm font-light text-white/80">Anime Styles</div>
              </div>
              <div className="text-center">
                <div className="text-heading-2 text-white">50K+</div>
                <div className="text-body-sm font-light text-white/80">Posters Created</div>
              </div>
              <div className="text-center">
                <div className="text-heading-2 text-white">Free</div>
                <div className="text-body-sm font-light text-white/80">No Watermark</div>
              </div>
              <div className="text-center">
                <div className="text-heading-2 text-white">HD</div>
                <div className="text-body-sm font-light text-white/80">Export Quality</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="text-feature-title mb-2">
                100+ Anime Styles
              </h3>
              <p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg prose-seo">
            <h2 className="text-section-title mb-6 text-center">The Ultimate Anime Poster Maker</h2>
            <p>
            ...
            <h3 className="text-heading-4">Authentic Anime Art Styles</h3>
            <p>
            ...
            <h3 className="text-heading-4">Japanese Typography Support</h3>
            <p>
            ...
            <h3 className="text-heading-4">Perfect for Every Anime Fan</h3>
            <p>
            ...
            <h3 className="text-heading-4">Free Anime Poster Creation</h3>
            <p>
