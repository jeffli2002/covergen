...
export async function generateMetadata({ params: { locale } }: { params: { locale: string } }): Promise<Metadata> {
  return generateToolMetadata({
    tool: 'event-poster-designer',
    locale,
    title: 'Event Poster Designer ',
    description: 'AI-powered event poster designer generator with perfect dimensions and instant results.',
    keywords: [/* Add relevant keywords */],
  })
}/tools/event-poster-designer`,
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto prose prose-lg">
              <h2>Professional Event Poster Design with AI Technology</h2>
              <p>
