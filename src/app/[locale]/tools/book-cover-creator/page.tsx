...
export default function BookCoverCreatorPage({ params: { locale } }: { params: { locale: string } }) {
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-white to-amber-50">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <h3 className="font-semibold mb-2">Fantasy & Sci-Fi</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              <div className="text-4xl mb-3">📖</div>
              <h3 className="font-semibold mb-2">Literary Fiction</h3>
      ...
      {/* CTA Section */}
      <section className="cta-section py-20 bg-gradient-to-r from-amber-600 to-orange-600">
