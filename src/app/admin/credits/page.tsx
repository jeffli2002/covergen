  ...
  return (
    <div className="p-6 space-y-6 bg-white text-gray-900">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold text-slate-900">Credits Management</h1>
          ...
          <CardContent>
            <div className="space-y-2">
              {data.top10Users.map((user, index) => (
                <div
                  key={user.id}
                  className="flex items-center justify-between border rounded-lg p-3 hover:bg-slate-50 bg-white transition-colors"
                >
                  <div className="flex items-center gap-3">
                    <div className="flex-shrink-0 w-8 h-8 rounded-full bg-teal-100 flex items-center justify-center text-slate-700 font-bold text-sm">
                      {index + 1}
                    </div>
                    <div>
