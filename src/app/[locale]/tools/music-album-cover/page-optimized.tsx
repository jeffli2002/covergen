...
export async function generateMetadata({ params: { locale } }: { params: { locale: string } }): Promise<Metadata> {
  return generateToolMetadata({
    tool: 'music-album-cover',
    locale,
    title: 'Music Album Cover ',
    description: 'AI-powered music album cover generator with perfect dimensions and instant results.',
    keywords: [/* Add relevant keywords */],
  })
}/tools/music-album-cover`,
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
              ...
              <GenreCard genre="Podcast" style="Clean, professional, branded" />
              <GenreCard genre="Mixtape" style="Street art, collage, custom" />
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto prose prose-lg">
              <h2>Professional Album Artwork Creation with AI Technology</h2>
              <p>
